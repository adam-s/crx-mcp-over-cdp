...
/* ----------------------- tools ----------------------- */
async function openImagesSearch(mcpClient: MCPStyleClient, query: string = 'baby elephants', pauseMs: number = 1200): Promise<string> {
...
export async function runDemo(driver: ChromeExtensionDriver) {
    ...
    const result = await runBabyElephantAgent('baby elephants', driver);
